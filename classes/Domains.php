...
class Domains {
	...
	public static function init():void {
		 ...
		 * @todo 캐시적용
		 */
		$domains = iModules::db()->select()->from(iModules::table('domains'))->orderBy('sort','asc')->get();
	...
	public static function all():array {
		if (isset(self::$_domains) == false) self::init();
	...
	public static function get(?string $host=null):Domain {
		...
		if (isset(self::$_domains[$host]) == true) return self::$_domains[$host];
